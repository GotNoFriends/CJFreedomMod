...
public class CJFM_DonatorList
{
    ...
    public static void loadDonatorList()
    {
        try
        {
            ...
            TFM_Util.createDefaultConfiguration(CJFreedomMod.DONATOR_FILE);
            FileConfiguration config = YamlConfiguration.loadConfiguration(new File(TotalFreedomMod.plugin.getDataFolder(), CJFreedomMod.DONATOR_FILE));
    ...
    {
        File a = new File(TotalFreedomMod.plugin.getDataFolder(), CJFreedomMod.DONATOR_FILE);
        File b = new File(TotalFreedomMod.plugin.getDataFolder(), CJFreedomMod.DONATOR_FILE + ".bak");
        FileUtil.copy(a, b);
    }
    ...
    public static void saveDonatorList()
    {
        try
        {
            ...
            config.save(new File(TotalFreedomMod.plugin.getDataFolder(), CJFreedomMod.DONATOR_FILE));
        }
        catch (Exception ex)
        {
            TFM_Log.severe(ex);
