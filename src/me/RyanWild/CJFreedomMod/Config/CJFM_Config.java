 ...
 */
public class CJFM_Config extends YamlConfiguration // BukkitLib @ https://github.com/Pravian/BukkitLib
{
     ...
     */
    public CJFM_Config(Plugin plugin, String fileName, boolean copyDefaults)
    {
     ...
     * @param copyDefaults If the defaults should be copied and/loaded from a config in the plugin jar-file.
     */
    public CJFM_Config(Plugin plugin, File file, boolean copyDefaults)
    {
        this.plugin = plugin;
    ...
    public void save()
    {
        ...
        {
            plugin.getLogger().severe("Could not save CJFreedom Custom configuration file: " + configFile.getName());
