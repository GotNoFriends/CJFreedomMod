...
public class Command_nope extends CJFM_Command
{
    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_BanManager.getInstance().addIpBan(new TFM_Ban(ip, p.getName(), sender.getName(), null, reason));

        // ban username:
        TFM_BanManager.getInstance().addUuidBan(new TFM_Ban(p.getUniqueId(), p.getName(), sender.getName(), null, reason));
